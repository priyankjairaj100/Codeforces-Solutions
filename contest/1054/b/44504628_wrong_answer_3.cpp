...
int main()
{
	LL n; cin>>n; LL a[n+1]; rep(i,1,n,1) cin>>a[i];
	if(a[1]!=0) {cout<<1<<endl; return 0;}
	if(a[2]!=1) {cout<<2<<endl; return 0;}
	if(a[3]!=2) {cout<<3<<endl; return 0;}
	LL m = 2;
	rep(i,4,n,1){ if(a[i]<=m+1){if(a[i]==m+1)m=m+1;} else{ cout<<i<<endl; return 0;} }
	cout<<"-1"<<endl;
	return 0;
}