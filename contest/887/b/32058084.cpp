...
int main()
{
    ...
    for(i=1;i<10;i++)
        ...
        for(i=100;i<1000;i++)
        {
            if(!(((a[((i/100)%10)] and b[((i/10)%10)]) and c[(i%10)]) ||((a[((i/100)%10)] and c[((i/10)%10)]) and b[(i%10)]) || ((b[((i/100)%10)] and a[((i/10)%10)]) and c[(i%10)]) || ((b[((i/100)%10)] and c[((i/10)%10)]) and a[(i%10)]) ||((c[((i/100)%10)] and a[((i/10)%10)]) and b[(i%10)]) ||((c[((i/100)%10)] and b[((i/10)%10)]) and a[(i%10)])))
            {
                cout<<i-1<<endl;
                return 0;
            }
