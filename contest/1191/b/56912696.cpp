...
int32_t main()
{
    ...
    if(num == 3 and ((x[id][1] - x[id][0] == 1 or x[id][1] - x[id][0] == 2) or (x[id][2] - x[id][1] == 1 or x[id][2] - x[id][1] == 2))) {cout<<1<<endl; return 0;}
    if(num == 2 and (x[id][0] - x[id][1] == -1 or x[id][1] - x[id][0] == 2)) {cout<<1<<endl; return 0;}
    if(m1 == 2) cout<<1<<endl;
    else cout<<2<<endl;
    return 0;
}